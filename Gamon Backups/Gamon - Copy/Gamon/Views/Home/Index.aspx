...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Order by 
        <select name="filterby">
            <option value="1" id="filterby-title">Title</option>
            <option value="2" id="filterby-addons">Addons</option>
        </select>
    ...
    <% foreach (var game in Model)
       { %>
       <tr>
       <td><a href="/addons/game/<%= game.Slug %>"><img src="<%= game.Cover %>" alt="<%= game.Title %>" /></a></td>
       <td>
