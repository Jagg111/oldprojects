...
namespace Gamon.Models
{
	...
	public partial class vw_Addon
	{
		...
		private string _AddonAvatar;
		
		private string _GameAvatar;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AddonAvatar", DbType="VarChar(250)")]
		public string AddonAvatar
		{
			get
			{
				return this._AddonAvatar;
			}
			set
			{
				if ((this._AddonAvatar != value))
				{
					this._AddonAvatar = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GameAvatar", DbType="VarChar(250)")]
		public string GameAvatar
		{
			get
			{
				return this._GameAvatar;
			}
			set
			{
				if ((this._GameAvatar != value))
				{
					this._GameAvatar = value;
				}
			}
		}
	}
